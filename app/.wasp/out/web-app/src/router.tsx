...
import HomePage from '../../../../src/landing-page/HomePage'
...
import AdminLearningAnalyticsPage from '../../../../src/admin/dashboards/learning/LearningAnalyticsDashboardPage'
import { NotFoundPage } from '../../../../src/client/components/NotFoundPage'
import AdminMessagesPage from '../../../../src/messages/MessagesPage'
import TopicSearchPage from '../../../../src/learning/TopicSearchPage'
import TopicPage from '../../../../src/learning/TopicPage'
...
export const routeNameToRouteComponent = {
  ...
  AdminLearningAnalyticsRoute: createAuthRequiredPage(AdminLearningAnalyticsPage),
  NotFoundRoute: NotFoundPage,
  AdminMessagesRoute: createAuthRequiredPage(AdminMessagesPage),
  TopicSearchRoute: createAuthRequiredPage(TopicSearchPage),
  TopicPageRoute: createAuthRequiredPage(TopicPage),
} as const;
