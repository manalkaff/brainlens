...
const LearningAnalyticsDashboard = ({ user }: { user: AuthUser }) => {
    ...
    <DefaultLayout user={user}>
      <div className="space-y-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Progress 
                  value={analytics?.totalUsers ? (analytics.subscribedUsers / analytics.totalUsers) * 100 : 0} 
                  className="h-2"
                />
                <p className="text-xs text-muted-foreground">
                  {analytics?.totalUsers ? 
                    Math.round((analytics.subscribedUsers / analytics.totalUsers) * 100) : 0
                  }% subscription rate
                </p>
              </CardContent>
            </Card>
          ...
          {/* Usage by Plan */}
          {analytics?.usageByPlan && analytics.usageByPlan.length > 0 && (
            <Card>
              <CardHeader>
