...
// Agent-specific search configurations for SearXNG
...
const GENERAL_RESEARCH_CONFIG: AgentSearchConfig = {
...
const ACADEMIC_RESEARCH_CONFIG: AgentSearchConfig = {
...
const COMPUTATIONAL_RESEARCH_CONFIG: AgentSearchConfig = {
...
const VIDEO_LEARNING_CONFIG: AgentSearchConfig = {
...
const COMMUNITY_DISCUSSION_CONFIG: AgentSearchConfig = {
...
export class AgentConfigManager {
  ...
  static getAgentNames(): AgentConfigName[] {
    return Object.keys(AGENT_SEARCH_CONFIGS) as AgentConfigName[];
  }
  ...
  static optimizeQuery(
    ...
    const queries: string[] = [baseQuery]; // Always include original query
    ...
    if (context?.userLevel) {
      ...
      const terms = levelTerms[context.userLevel as keyof typeof levelTerms] || [];
      terms.forEach(term => {
