...
export const databaseConnectionRecovery: RecoveryStrategy = {
...
// AI service recovery
export const aiServiceRecovery: RecoveryStrategy = {
  canRecover: (error) => 
    error.type === ErrorType.AI_API_ERROR || 
...
export const vectorStoreRecovery: RecoveryStrategy = {
...
export const networkRecovery: RecoveryStrategy = {
  canRecover: (error) => 
...
export const authenticationRecovery: RecoveryStrategy = {
  canRecover: (error) => 
...
export const dataCorruptionRecovery: RecoveryStrategy = {
  canRecover: (error) => 
    error.type === ErrorType.PARSING_ERROR ||
...
function cleanCorruptedData(rawData: any): any {
  try {
...
export async function attemptAutomaticRecovery(
  error: LearningPlatformError,
  context?: any
): Promise<boolean> {
...
export const learningOperationRecovery: RecoveryStrategy = {
  canRecover: (error) => 
    error.type === ErrorType.TOPIC_NOT_FOUND ||
