      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div
              key={i}
              className="bg-card rounded-xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border animate-pulse"
            >
              {/* Icon Skeleton */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="space-y-3">
              ...
              <div className="space-y-2">
                {[1, 2, 3].map((j) => (
                  <div key={j} className="h-4 bg-muted/20 rounded w-3/4 animate-pulse" />
                ))}
              </div>
            </div>
          ))}
        ...
        <div className="border-t border-border pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            ...
            <div className="flex space-x-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="w-8 h-8 bg-muted/30 rounded animate-pulse" />
              ))}
            </div>
          </div>
        </div>
