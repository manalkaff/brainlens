import { type Entity, type EntityName, type User, type GptResponse, type Task, type File, type DailyStats, type PageViewSource, type Logs, type ContactFormMessage, type Topic, type GeneratedContent, type UserTopicProgress, type ChatThread, type Message, type Quiz, type QuizQuestion, type VectorDocument } from 'wasp/entities';
...
export type _Entity = _User | _GptResponse | _Task | _File | _DailyStats | _PageViewSource | _Logs | _ContactFormMessage | _Topic | _GeneratedContent | _UserTopicProgress | _ChatThread | _Message | _Quiz | _QuizQuestion | _VectorDocument | never;
