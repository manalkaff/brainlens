    ...
    return (<div className='flex flex-col gap-4'>
      <div className='rounded-sm border border-border bg-card shadow'>
        ...
        <div className='border-t-4 border-border'>
          {/* Bulk Actions */}
          {selectedUsers.length > 0 && (<div className='bg-blue-50 border-b border-border p-4 flex items-center justify-between'>
              ...
              <div className='flex items-center gap-2'>
                <BulkQuotaManager selectedUsers={selectedUsers} onUpdate={handleQuotaUpdate}/>
              </div>
            </div>)}
          ...
          <div className='grid grid-cols-10 py-4.5 px-4 md:px-6'>
            <div className='col-span-1 flex items-center'>
              <Checkbox checked={data?.users ? selectedUsers.length === data.users.length : false} onCheckedChange={handleSelectAll}/>
            </div>
        ...
        {!!data?.users &&
            data?.users?.length > 0 &&
            data.users.map((user) => (<div key={user.id} className='grid grid-cols-10 gap-4 py-4.5 px-4 md:px-6 border-b border-border/50'>
              <div className='col-span-1 flex items-center'>
                <Checkbox checked={selectedUsers.includes(user.id)} onCheckedChange={(checked) => handleUserSelect(user.id, checked)}/>
              </div>
              <div className='col-span-2 flex items-center'>
              ...
              <div className='col-span-2 flex items-center'>
                <div className='flex flex-col gap-1'>
                  ...
                  {user.subscriptionStatus && (<p className='text-xs text-muted-foreground'>
