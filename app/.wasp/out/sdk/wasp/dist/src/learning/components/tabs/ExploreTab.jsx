              ...
              <div className="space-y-6">
                ...
                {researchResult.mainTopic.subtopics.length > 0 && (<div className="mt-8 border-t pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {researchResult.mainTopic.subtopics.map((subtopic, index) => (<Card key={index} className="cursor-pointer hover:shadow-md transition-shadow">
              ...
              {currentContent.content && !isGeneratingContent && !isLoadingContent ? (<div key={`content-${activeTopicForContent.id}`} className="p-6 space-y-6">
                  ...
                  {(activeTopicForContent?.children && activeTopicForContent.children.length > 0) ||
                    ...
                    <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {researchResult.mainTopic.subtopics.map((subtopic, index) => (<div key={index} className="cursor-pointer hover:shadow-md transition-shadow p-4 border rounded-lg">
                                <h3 className="font-medium text-sm">{subtopic.title}</h3>
                                <p className="text-xs text-muted-foreground mt-1 line-clamp-2">
                                  {subtopic.description}
                                </p>
