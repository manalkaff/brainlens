...
export function LoadingSkeleton() {
    return (<div className="flex h-[calc(100vh-200px)] bg-background">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-2">
            {Array.from({ length: 6 }).map((_, i) => (<div key={i} className="space-y-2">
                ...
                {i < 3 && (<div className="ml-6 space-y-1">
                    {Array.from({ length: 2 }).map((_, j) => (<div key={j} className="flex items-center gap-2 p-2">
                        <div className="w-4 h-4 bg-muted rounded animate-pulse"/>
                        <div className="w-4 h-4 bg-muted rounded animate-pulse"/>
...
export function CompactLoadingSkeleton() {
    return (<div className="space-y-4 p-4">
      ...
      {/* Tree Items Skeleton */}
      <div className="space-y-2">
        {Array.from({ length: 8 }).map((_, i) => (<div key={i} className="flex items-center gap-2 p-2">
