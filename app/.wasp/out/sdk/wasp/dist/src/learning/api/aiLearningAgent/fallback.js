...
export class FallbackModule {
     ...
     */
    createFallbackContent(topic, synthesis, error, formatAsMDX, estimateReadTime) {
        ...
        const fallbackContent = {
            ...
            keyTakeaways,
            nextSteps,
            estimatedReadTime: estimateReadTime(sections.reduce((total, section) => total + section.content.length, 0))
        };
    ...
    createFallbackTakeaways(topic, insights, themes) {
        const takeaways = [
