 ...
 */
export function fuzzyStringSimilarity(str1, str2) {
    if (str1 === str2)
        return 1.0;
    if (!str1 || !str2)
        return 0;
    ...
    return (jaccardSim * weights.jaccard +
 ...
 */
export function detectNearDuplicates(content1, content2, threshold = 0.8) {
    const reasons = [];
    let totalScore = 0;
    let maxScore = 0;
    // Exact match
...
function calculateTFIDF(words, vocabulary) {
    const tf = new Map();
