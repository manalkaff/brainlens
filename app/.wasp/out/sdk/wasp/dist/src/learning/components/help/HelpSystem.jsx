...
import { HelpCircle, BookOpen, Brain, Search, Lightbulb } from 'lucide-react';
export function HelpSystem({ trigger, defaultTab = 'overview' }) {
    const [open, setOpen] = useState(false);
    const defaultTrigger = (<Button variant="ghost" size="sm" className="gap-2">
...
//# sourceMappingURL=HelpSystem.jsx.map