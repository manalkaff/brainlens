...
export function EnhancedEmptyState({ onStartExploring, hasRecentTopics }) {
      ...
      <Card className="w-full max-w-lg">
        <CardContent className="p-8 text-center space-y-6">
          ...
          <div className="space-y-3">
            <Button onClick={onStartExploring} className="w-full">
              <Search className="w-4 h-4 mr-2"/>
              Browse Topics
            </Button>
            
            {hasRecentTopics && (<Button variant="outline" onClick={() => onStartExploring()} className="w-full">
...
//# sourceMappingURL=EnhancedEmptyState.jsx.map