...
export const IntroductionSection = ({ className = '' }) => {
    return (<section id="introduction" className={`py-16 sm:py-20 lg:py-24 bg-background ${className}`} aria-labelledby="introduction-title">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div>
                <h2 id="introduction-title" className="text-title-md sm:text-title-lg md:text-title-xl lg:text-title-xxl font-bold text-foreground mb-4 sm:mb-6 leading-tight tracking-tight">
              ...
              <div className="space-y-4 sm:space-y-6" role="list" aria-label="Platform benefits">
                <div className="flex items-start space-x-3 sm:space-x-4 group" role="listitem">
                  <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-primary/10 rounded-lg flex items-center justify-center transition-all duration-300 group-hover:bg-primary/20 group-hover:scale-110" aria-hidden="true">
                ...
                <div className="flex items-start space-x-3 sm:space-x-4 group" role="listitem">
                  <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-success/10 rounded-lg flex items-center justify-center transition-all duration-300 group-hover:bg-success/20 group-hover:scale-110" aria-hidden="true">
                ...
                <div className="flex items-start space-x-3 sm:space-x-4 group" role="listitem">
                  <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-accent/50 rounded-lg flex items-center justify-center transition-all duration-300 group-hover:bg-accent group-hover:scale-110" aria-hidden="true">
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="bg-gradient-to-br from-muted/50 to-accent/30 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-border/50 transition-all duration-500 hover:shadow-2xl hover:border-border" role="img" aria-label="Demonstration of AI research process creating a learning path">
                  ...
                  <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-card rounded-lg shadow-sm border border-border/30">
                    ...
                    <div className="space-y-1.5 sm:space-y-2" role="list" aria-label="Sample learning path steps">
                      <div className="flex items-center space-x-2" role="listitem">
                        <div className="w-2 h-2 bg-success rounded-full" aria-label="Completed step"></div>
                        <span className="text-xs sm:text-sm text-foreground">Introduction & Basics</span>
                      </div>
                      <div className="flex items-center space-x-2" role="listitem">
                        <div className="w-2 h-2 bg-warning rounded-full" aria-label="In progress step"></div>
                        <span className="text-xs sm:text-sm text-foreground">Core Concepts</span>
                      </div>
                      <div className="flex items-center space-x-2" role="listitem">
                        <div className="w-2 h-2 bg-muted-foreground rounded-full" aria-label="Upcoming step"></div>
...
//# sourceMappingURL=IntroductionSection.jsx.map