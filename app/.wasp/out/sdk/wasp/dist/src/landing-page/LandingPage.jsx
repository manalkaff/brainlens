...
import { IntroductionSkeleton, FeaturesSkeleton, FAQSkeleton, FooterSkeleton } from './components/SkeletonLoaders';
// Lazy load non-critical sections
const IntroductionSection = lazy(() => import('./components/IntroductionSection').then(module => ({
    default: module.IntroductionSection
})));
const FeaturesSection = lazy(() => import('./components/FeaturesSection').then(module => ({
    default: module.FeaturesSection
})));
const FAQSection = lazy(() => import('./components/FAQSection').then(module => ({
    default: module.FAQSection
})));
const FooterSection = lazy(() => import('./components/FooterSection').then(module => ({
...
export default function LandingPage() {
    ...
    return (<div className="min-h-screen">
      ...
      <a href="#hero" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-primary text-primary-foreground px-4 py-2 rounded-md z-50 focus:outline-none focus:ring-2 focus:ring-primary-foreground">
      ...
      <main role="main">
        ...
        <HeroSection onTopicSubmit={handleTopicSubmit} isLoading={isCreating}/>
