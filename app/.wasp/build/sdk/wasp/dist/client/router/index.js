...
export const routes = {
    ...
    HomePageRoute: {
        to: "/home",
        build: (options) => interpolatePath("/home", undefined, options?.search, options?.hash),
    },
    LoginRoute: {
        to: "/login",
    ...
    AdminLearningAnalyticsRoute: {
        to: "/admin/learning",
        build: (options) => interpolatePath("/admin/learning", undefined, options?.search, options?.hash),
    },
    NotFoundRoute: {
        to: "*",
    ...
    TopicSearchRoute: {
        to: "/learn",
        build: (options) => interpolatePath("/learn", undefined, options?.search, options?.hash),
    },
    TopicPageRoute: {
        to: "/learn/:slug",
        build: (options) => interpolatePath("/learn/:slug", options.params, options?.search, options?.hash),
    },
};
// PUBLIC API
