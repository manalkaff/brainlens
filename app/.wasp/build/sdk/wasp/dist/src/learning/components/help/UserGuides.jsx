...
import { BookOpen, MessageCircle, Map, Brain, Trophy, Play, CheckCircle, ArrowRight, Lightbulb, Target, Zap } from 'lucide-react';
const tabGuides = [
    {
        id: 'learn',
        name: 'Learn Tab',
...
export function UserGuides({ defaultTab = 'learn' }) {
        ...
        <div className="lg:col-span-1">
          <Card>
            ...
            <CardContent className="space-y-2">
              {tabGuides.map(guide => (<Button key={guide.id} variant={selectedGuide === guide.id ? "default" : "ghost"} className="w-full justify-start gap-2" onClick={() => setSelectedGuide(guide.id)}>
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {currentGuide.bestFor.map(item => (<Badge key={item} variant="secondary">
                          {item}
                        </Badge>))}
                    </div>
                  </div>
                ...
                <TabsContent value="steps" className="space-y-4">
                  <div className="space-y-4">
                    {currentGuide.steps.map((step, index) => (<Card key={index}>
                        ...
                        <CardContent>
                          ...
                          {step.tips && (<div>
                              ...
                              <ul className="space-y-1">
                                {step.tips.map((tip, tipIndex) => (<li key={tipIndex} className="text-sm text-muted-foreground flex items-start gap-2">
                ...
                <TabsContent value="tips" className="space-y-4">
                  <div>
                    ...
                    <div className="space-y-3">
                      {currentGuide.proTips.map((tip, index) => (<div key={index} className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
...
//# sourceMappingURL=UserGuides.jsx.map