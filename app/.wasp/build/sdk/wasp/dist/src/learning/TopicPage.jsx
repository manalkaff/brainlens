...
function LazyTabContent({ tabId, children, }) {
...
export default function TopicPage() {
    ...
    return (<StreamingErrorBoundary onRetry={() => window.location.reload()} onReset={() => (window.location.href = "/learn")} showDetails={process.env.NODE_ENV === "development"}>
...
function TopicPageContent() {
    ...
    if (error) {
        return (<StreamingErrorBoundary onRetry={() => window.location.reload()} onReset={() => window.location.reload()} showDetails={process.env.NODE_ENV === "development"}>
        <Card>
    ...
    return (<SidebarProvider>
      ...
      <SidebarInset>
        ...
        <header className="flex h-16 shrink-0 items-center gap-4 border-b px-4">
          ...
          <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value)} className="flex items-center">
...
//# sourceMappingURL=TopicPage.jsx.map