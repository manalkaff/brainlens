...
export const generateSubtopicsHandler = async (req, res, context) => {
    try {
        if (!context.user) {
...
function buildSubtopicGenerationPrompt(topicTitle, topicSummary, currentDepth, parentTitle) {
...
function parseSubtopicsFromResponse(response) {
...
//# sourceMappingURL=generateSubtopics.js.map