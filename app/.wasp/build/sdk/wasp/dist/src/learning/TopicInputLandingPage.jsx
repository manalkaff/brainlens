...
export default function TopicInputLandingPage() {
    ...
    return (<div className='min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950/30'>
        ...
        <div className='w-full max-w-2xl mx-auto space-y-12'>
          ...
          <Card className='border-0 shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm'>
            <CardContent className='p-8 space-y-6'>
              ...
              <div className='space-y-4'>
                <Textarea placeholder='e.g., "How neural networks work", "Ancient Roman history", "React hooks patterns"...' value={topicInput} onChange={(e) => setTopicInput(e.target.value)} className='min-h-[120px] text-base resize-none border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50 focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 dark:focus:border-blue-500 transition-all duration-200 rounded-xl px-4 py-3 placeholder:text-slate-400 dark:placeholder:text-slate-500' onKeyDown={(e) => {
            if (e.key === 'Enter' && (e.metaKey || e.ctrlKey)) {
                ...
                <div className='flex items-center justify-between pt-2'>
                  ...
                  <Button onClick={handleStartLearning} disabled={!topicInput.trim() || isCreating} className='px-8 py-2.5 h-11 font-medium bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 border-0 shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transition-all duration-200' size='lg'>
                    {isCreating ? (<>
          ...
          {!user && (<div className='text-center pt-4'>
              <p className='text-sm text-slate-500 dark:text-slate-400'>
                <WaspRouterLink to={routes.SignupRoute.to} className='text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors'>
                  Sign up
                </WaspRouterLink>{' '}
...
//# sourceMappingURL=TopicInputLandingPage.jsx.map