...
export function OfflineIndicator({ 
  ...
  const CompactIndicator = () => (
    ...
    >
      ...
      {capabilities.isServiceWorkerRegistered && (
      ...
      <CardContent className="p-4 space-y-4">
        ...
        {capabilities.isServiceWorkerRegistered && (
          <div className="space-y-3">
            ...
            {Object.entries(cacheStats).map(([cacheName, count]) => (
              <div key={cacheName} className="flex items-center justify-between text-sm">
        ...
        {storageEstimate && (
          <div className="space-y-2">
            ...
            <Progress 
              value={getUsedStoragePercentage()} 
              className="h-2"
            />
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            ...
            <div className="flex items-center gap-1">
              {capabilities.periodicSyncSupported ? (
                <CheckCircle className="w-3 h-3 text-green-600" />
              ) : (
                <X className="w-3 h-3 text-red-600" />
              )}
        ...
        <div className="flex gap-2 pt-2 border-t">
          <Button 
            ...
            disabled={getTotalCachedItems() === 0}
            className="flex-1"
          >
            Clear Cache
          </Button>
