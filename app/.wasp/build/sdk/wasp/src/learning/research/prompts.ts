...
export class GeneralQueryOptimizer implements QueryOptimizer {
...
export class AcademicQueryOptimizer implements QueryOptimizer {
...
export class ComputationalQueryOptimizer implements QueryOptimizer {
...
export class VideoQueryOptimizer implements QueryOptimizer {
...
export class CommunityQueryOptimizer implements QueryOptimizer {
  ...
  optimize(topic: string, context?: any): string[] {
    ...
    if (context?.platforms) {
      context.platforms.forEach((platform: string) => {
...
export class TopicContextEnhancer implements ContextEnhancer {
  name = 'Topic Context Enhancer';
  description = 'Enhances queries with topic-specific context';

  enhance(topic: string, context?: any): Record<string, any> {
    const enhancement: Record<string, any> = {
      originalTopic: topic,
  ...
  private identifyRelatedConcepts(topic: string): string[] {
  ...
  private generateSearchFilters(topic: string, context?: any): Record<string, any> {
...
export class UserContextEnhancer implements ContextEnhancer {
...
export class PromptTemplateManager {
  ...
  private static optimizers: Map<string, QueryOptimizer> = new Map();
  private static enhancers: Map<string, ContextEnhancer> = new Map();
  ...
  static enhanceContext(agentName: string, topic: string, context?: any): Record<string, any> {
    ...
    let enhancedContext: Record<string, any> = { ...context };
...
export function getOptimizedQueries(agentName: string, topic: string, context?: any): string[] {
  return PromptTemplateManager.optimizeQuery(agentName, topic, context);
}

export function getEnhancedPrompt(agentName: string, topic: string, context?: any): string {
  return PromptTemplateManager.generatePrompt(agentName, topic, context);
}

export function getEnhancedContext(agentName: string, topic: string, context?: any): Record<string, any> {
