        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {features.map((feature, index) => (
              <article
                key={feature.id}
                className="group bg-card rounded-xl p-4 sm:p-6 lg:p-8 shadow-lg border border-border transition-all duration-500 ease-out hover:shadow-2xl hover:-translate-y-2 hover:border-primary/30 focus-within:shadow-2xl focus-within:border-primary/30"
                style={{
              ...
              >
                {/* Icon */}
                <div 
                  className="w-12 h-12 sm:w-14 sm:h-14 bg-primary/10 rounded-lg flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-primary/20 group-hover:scale-110 transition-all duration-300"
                  aria-hidden="true"
                >
                ...
                <div>
                  <h3 
                    ...
                    className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-3 transition-colors duration-200"
                  >
                    {feature.title}
                  </h3>
                  <p 
                    id={`feature-desc-${feature.id}`}
                    className="text-sm sm:text-base text-muted-foreground leading-relaxed transition-colors duration-200"
                  >
                    {feature.description}
                  </p>
                </div>
          ...
          <div className="text-center mt-12 sm:mt-14 lg:mt-16">
            ...
            <button 
              ...
              className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 min-h-[44px] touch-manipulation focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background focus:bg-primary/90 focus:scale-105"
              type="button"
              aria-label="Go back to the top of the page to start creating your learning path"
            >
              Get Started Now
            </button>
          </div>
