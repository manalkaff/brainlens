...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section 
      id="hero" 
      className="h-screen flex flex-col items-center justify-center relative bg-gradient-to-br from-background via-muted/30 to-accent/20 overflow-hidden"
      role="banner"
    ...
    >
      ...
      {!reducedMotion && (
        <>
          <div 
            className="absolute top-1/4 left-1/4 w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 bg-primary/10 rounded-full blur-3xl will-change-transform"
            style={{
          ...
          />
          <div 
            className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-72 sm:h-72 lg:w-96 lg:h-96 bg-primary/8 rounded-full blur-3xl will-change-transform"
            style={{
      ...
      <div className="relative z-10 pb-6 sm:pb-8">
        <button
          ...
          className="flex flex-col items-center space-y-2 text-muted-foreground hover:text-foreground transition-all duration-300 ease-out group min-h-[44px] min-w-[44px] p-3 rounded-xl hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background focus:bg-muted/50"
          aria-label="Scroll to introduction section to learn more about our platform"
          type="button"
        >
