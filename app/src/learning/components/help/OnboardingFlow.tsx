...
import { CheckCircle, ArrowRight, ArrowLeft, Sparkles, BookOpen, MessageCircle, Map, Brain, Trophy } from 'lucide-react';
...
export function OnboardingFlow({ isOpen, onClose, onComplete, currentTab }: OnboardingFlowProps) {
