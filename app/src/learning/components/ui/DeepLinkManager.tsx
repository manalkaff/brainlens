...
export function DeepLinkManager({
  ...
  const navigateToTestedLink = useCallback(() => {
    if (!testResult?.isValid || !onNavigateToDeepLink) return;
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2">
              <Input
                id="test-url"
                placeholder="Paste a topic URL to test..."
                value={testURL}
              ...
              <Alert className={testResult.isValid ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}>
                <div className="flex items-start space-x-2">
                  ...
                  <div className="flex-1">
                    ...
                    {testResult.isValid && testResult.topic && onNavigateToDeepLink && (
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={navigateToTestedLink}
                        className="mt-2"
                      >
...
export function useDeepLinkManager() {
  ...
  const validateAndNavigate = useCallback(async (
    url: string,
    validateDeepLink: (path: string[]) => any,
