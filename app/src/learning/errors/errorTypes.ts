...
export function createLearningError(
  ...
  const error = new Error(message) as LearningPlatformError;
...
export const createDatabaseError = (operation: string, cause?: Error, context?: Record<string, any>) =>
  createLearningError(
...
export const createAIServiceError = (service: string, cause?: Error, context?: Record<string, any>) =>
  createLearningError(
...
export const createVectorStoreError = (operation: string, cause?: Error, context?: Record<string, any>) =>
  createLearningError(
...
export const createResearchPipelineError = (stage: string, cause?: Error, context?: Record<string, any>) =>
  createLearningError(
...
export function classifyError(error: Error): LearningPlatformError {
...
// Type guard
export function isLearningPlatformError(error: any): error is LearningPlatformError {
  return error && typeof error === 'object' && 'type' in error && 'code' in error;
}

// Error logging utility
export function logError(error: LearningPlatformError, context?: Record<string, any>) {
  const logData = {
